...
globalkeys = my_table.join(
    ...
    awful.key({ modkey, "Shift"   }, "Return", function () awful.spawn(gnometerminal) end,
              {description = "open gnome-terminal", group = "launcher"}),
    ...
    --awful.key({ modkey }, "p", function ()
            ...
            --os.execute(string.format("dmenu_recency",
